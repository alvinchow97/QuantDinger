...
| `setup-git-hooks.ps1` | Activate this repo's commit-msg/pre-push git hooks on Windows. | Keep |
| `setup-git-hooks.sh` | Activate this repo's commit-msg/pre-push git hooks on macOS/Linux. | Keep |
